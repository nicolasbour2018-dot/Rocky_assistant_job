...
SKILL_ALIASES = {
    ...
    "Google Apps Script": [
        ...
        "apps script",
        "appscript",
        "développement en google apps script",
        "developpement en google apps script",
        "développer en google apps script",
        "developper en google apps script",
    ],
    "Google Workspace": [
        "google workspace",
    ...
    "Low-code / No-code": [
        ...
        "developpement low code",
        "développement no-code",
        "developpement no code",
        "solutions no-code",
        "solutions no code",
    ...
    "Règles de gestion": [
        ...
        "formalisation des regles de gestion",
        "business rules",
    ],
    ...
    "MLOps": [
        ...
        "operations de machine learning",
    ],
    "CI/CD": [
        "ci/cd",
        "ci cd",
    ...
    "Travail en équipe": [
        ...
        "collaboration avec les equipes",
        "capacité à travailler en équipe",
        "capacite a travailler en equipe",
        "capacité à collaborer avec les équipes",
        "capacite a collaborer avec les equipes",
    ],
    ...
    "Pédagogie": [
        ...
        "capacite a vulgariser des resultats complexes",
        "capacité à vulgariser des resultats complexes",
        "capacite a vulgariser des résultats complexes",
    ],
...
def contains_expression(text: str, expression: str) -> bool:
    ...
    pattern = r"(?<![a-z0-9])" + re.escape(normalized_expression) + r"(?![a-z0-9])"
...
def extract_skills(title: str | None, description: str | None) -> dict[str, list[str]]:
    ...
    """
    source_text = normalize_text(f"{title or ''} {description or ''}")
    ...
    return {
        "technical_skills": sorted(detected_skills.intersection(TECHNICAL_SKILLS)),
        "business_skills": sorted(detected_skills.intersection(BUSINESS_SKILLS)),
        "soft_skills": sorted(detected_skills.intersection(SOFT_SKILLS)),
